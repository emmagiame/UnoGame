...
public abstract class GameMainActivity extends Activity implements View.OnClickListener {
    ...
    // A reference to the object representing the game itself. This is the object that knows the rules of the game. This variable is initialized in launchGame.
    ...
    // whether it is so early in the game that the configuration screen may not have been fully linked to the GUI
    private boolean justStarted = true;

    // whether the game is in the "configuration" stage, before the actual game has started
